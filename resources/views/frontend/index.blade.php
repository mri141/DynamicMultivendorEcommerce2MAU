...
{{-- Classified Product --}}
    @php
        $sliders = \App\Models\AddBannerSlider::where('is_paid',1)->where('approved_by_admin',1)->get();
    @endphp
            <!--Under header Ads-->
               <section  class="mt-0">
                   <div class="row">
                ...
                .menu-btn-sm-0{
                    ...
                    padding-left: 0px;
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm mt-2 pl-lg-3 pr-lg-3 pl-sm-3 pr-sm-3"> 
                                       <a href="#" data-target="#food" data-toggle="modal"
                                            class="d-block text-reset shadow-md mb-2" style="background-image: linear-gradient(to right top, #ec3768, #d02877, #ad2581, #852986, #572c84); border-radius: 10px;">
                                                <div class="text-truncat-2 pl-2 menu-text-style fw-600 text-center py-3 icon-hover">Food Mart</div>
                                        </a>
                            ...
                            <div class="col-sm mt-2 pl-lg-0 pr-lg-0 pl-sm-0 pr-sm-0"> 

                                <a href="#" data-target="#global_market" data-toggle="modal"
                                    class="d-block text-reset shadow-md mb-2 menu-btn-sm" style="background-image: linear-gradient(to right top, #ec3768, #d02877, #ad2581, #852986, #572c84); border-radius: 10px;">
                                   
                                        <div class="text-truncat-2 menu-text-style fw-600 text-center py-3 icon-hover">Global Market</div>
                           ...
                           <!-- Global Market Modal -->
                            ...
                            <div class="col-sm mt-2 pl-lg-3 pr-lg-3 pl-sm-3 pr-sm-3"> 
                                       <a href="#" data-target="#job" data-toggle="modal"
                                            class="d-block text-reset shadow-md mb-2" style="background-image: linear-gradient(to right top, #ec3768, #d02877, #ad2581, #852986, #572c84); border-radius: 10px;">
                                                <div class="text-truncat-2 pl-2 menu-text-style fw-600 text-center py-3 icon-hover">Job Market</div>
                                        </a>
                            ...
                            <div class="col-sm mt-2 pl-lg-0 pr-lg-0 pl-sm-0 pr-sm-0"> 
                                 <div class="">
                                       <a href="#" data-target="#ticket" data-toggle="modal"
                                            class="d-block text-reset shadow-md mb-2" style="background-image: linear-gradient(to right top, #ec3768, #d02877, #ad2581, #852986, #572c84); border-radius: 10px;">
                                                <div class="text-truncat-2 pl-2 menu-text-style fw-600 text-center py-3 icon-hover">Ticket & Tour</div>
                                        </a>
                                </div>
                            ...
                            <div class="col-sm mt-2 pl-lg-3 pr-lg-3 pl-sm-3 pr-sm-3"> 
                                <a href="#" data-target="#medicine" data-toggle="modal"
                                    class="d-block text-reset shadow-md mb-2" style="background-image: linear-gradient(to right top, #ec3768, #d02877, #ad2581, #852986, #572c84); border-radius: 10px;">
                                        <div class="text-truncat-2 pl-2 menu-text-style fw-600 text-center py-3 icon-hover">Medicine</div>
                                </a>
                            </div>
                            <!-- Medicine Modal -->
                       ...
                       <div class="rounded">
                            <div class="d-flex mb-3 align-items-baseline">
                                <h3 class="h5 fw-700 mb-0">
                                    <span class="border-width-2 d-inline-block fs-sm-16-title">Offer</span>
                   ...
                   <div class="container " >
                       <div class="rounded" style="background-color: transparent;">
                            ...
                            <!--<div class="d-flex mb-2 align-items-baseline title-line">-->
                                ...
                                <h3 class="h5 fw-700 mb-0">
                                    <span class="pb-3 d-inline-block fs-sm-16-title">Advertisement</span>
                                    <!--{{ translate('Classified Ads') }}-->
  ...
  <!--  </div>  -->
     ...
     <div  class="mb-4 mt-4">
                ...
                <div class="container " >
                     <div class="d-flex mb-3 align-items-baseline">
                                <h3 class="h5 fw-700 mb-0">
                                    <span class="border-width-2 d-inline-block fs-sm-16-title">Corporate Ad</span>
                                    <!--{{ translate('Classified Ads') }}-->
                                </h3>
                            </div>
    ...
    <div id="section_home_categories">
     ...
     <div  class="mb-4 mt-4">
                <div class="container ">
                    <div class="d-flex mb-3 align-items-baseline">
                                <h3 class="h5 fw-700 mb-0">
                                    <span class="border-width-2 d-inline-block fs-sm-16-title">Ad Store</span>
                                    <!--{{ translate('Classified Ads') }}-->
                                </h3>
                            </div>
                    <div class="row">
        ...
        @endphp
                   <div class="container " >
                       <div class="rounded">
                            <div class="d-flex mb-3 align-items-baseline">
                                <h3 class="h5 fw-700 mb-0">
                                    <span class="border-width-2 d-inline-block fs-sm-16-title" style="border-color: #572c84 !important;">Our Partners</span>
                                   
                                    
                                </h3>
                            </div>
                           <div class="aiz-carousel gutters-10 half-outside-arrow" data-ride="carousel" data-items="6"  data-xl-items="6" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-autoplay="true" data-arrows="true" autoplaySpped="2000" data-infinite="true">
                                        ...
                                        <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                            <div class="position-relative">
                                                <a href="" class="d-block d-flex justify-content-between">
                                                    <img
                                                        class="img-fit lazyload mx-auto h-140px h-md-165px" 
