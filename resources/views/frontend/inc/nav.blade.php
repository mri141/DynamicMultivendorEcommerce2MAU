...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
    ...
    <div class="under-header-bg">
     <div class="container border-gray-200">
                <ul class="list-inline mb-0 mobile-hor-swipe text-right">
                    
                     <li class="list-inline-item mr-0">
                        <a style="font-family: 'Roboto', sans-serif;"
                            href="{{ route('shops.create') }}"
                            class="fs-md-15 fs-16 fs-sm-13 fs-xs-12 px-3 pl-md-3 py-2 d-inline-block hov-opacity-100 text-reset fw-600">
                            <span class="menu-text-hover"> Be a Seller</span>
                        </a>
                    </li>
                    <li class="list-inline-item mr-0">
                        <a style="font-family: 'Roboto', sans-serif;"
                            ...
                            <span class="menu-text-hover"> {{ translate('Be a Customer')}} </span>
                        </a>
                    </li>
                      ...
                      <li class="list-inline-item mr-0">
                        <a style="font-family: 'Roboto', sans-serif;"
                            ...
                            class="fs-md-15 fs-sm-13 fs-xs-12 fs-16 px-3 py-2 d-inline-block hov-opacity-100 text-reset fw-600">
                            <span class="menu-text-hover"> {{ translate('Track My Order')}} </span>

                        </a>
                    </li>
                    <li class="list-inline-item mr-0">
                        <a href="{{ route('customer.care') }}" style="font-family: 'Roboto', sans-serif;"
                            class="fs-md-15 fs-sm-13 fs-xs-12 fs-16 px-3 py-2 d-inline-block hov-opacity-100 text-reset fw-600">
                            <span class="menu-text-hover">{{ translate('Customer Care')}} </span>

                        </a>
                    </li>
                    
                    <!-- <li class="list-inline-item mr-0">-->
                    <!--    <a href="https://sobkisubazar.com/customer-care" style="font-family: 'Roboto', sans-serif;"-->
                    <!--        href="https://sobkisubazar.com/live"-->
                    <!--        class="fs-md-15 fs-17 px-2 py-2 d-inline-block  hov-opacity-100 text-reset fw-600">-->
                    <!--        <span class="menu-text-hover">{{ translate('Live')}} </span>-->

                    <!--    </a>-->
                    <!--</li>-->
                    <!--<li class="list-inline-item mr-0">-->
                    <!--    <a href="https://sobkisubazar.com/entertainment" style="font-family: 'Roboto', sans-serif;"-->
                    <!--        href="https://sobkisubazar.com/customer-care"-->
                    <!--        class="fs-md-15 fs-17 px-2 py-2 d-inline-block  hov-opacity-100 text-reset fw-600">-->
                    <!--        <span class="menu-text-hover">{{ translate('Entertainment')}} </span>-->
                    ...
                    <!--<li class="list-inline-item mr-0">-->
                    <!--    <a style="color:#8f8787 !important;opacity:10 !important; font-family: 'Roboto', sans-serif;" href="{{ route('user.registration') }}"-->
                    <!--        class="opacity-60 fs-17 px-3 py-2 d-inline-block  hov-opacity-100 text-reset">-->
                    <!--        <span class="menu-text-hover"> {{ translate('Sign Up')}} </span>-->
                    <!--    </a>-->
                    <!--</li>-->
                     ...
                     <li class="list-inline-item mr-0">
                        <a href="#"  class="py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset">
                            <button type="button" class="btn btn-rounded live-btn">Live</button>
                        </a>
                    ...
                    <li class="list-inline-item mr-0">
                        <a href="#"  class="py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset">
                            <button type="button" class="btn btn-rounded get-app-btn">Entertainment</button>
                        </a>
                     ...
                     <li class="list-inline-item mr-0">
                        <a href="#"  class="py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset">
                            <button type="button" class="btn btn-rounded get-app-btn">Get Apps</button>
                        </a>
                    ...
                    @if (!Auth::check())
                        <li class="list-inline-item mr-0">
                            ...
                            <a class="fs-18 py-2 pl-4 d-inline-block fw-600 hov-opacity-100 text-reset" href="{{ route('user.login') }}">
                                <button type="button" class="btn btn-rounded get-app-btn">Log In</button>
                            </a>
