   ...
   <div class="container" >
      <div class="row no-gutters">
         <div class="col-lg-3 col-sm-6">
            <div class="my-4">
                 <p class="f-icon-text"><span class="f-icon"><i class="fa-solid fa-sack-dollar fa-2x text-white" style="margin-bottom: 10px;"></i></span><br/> Cash On Delivery </p>
            </div>
         </div>
         
           <div class="col-lg-3 col-sm-6">
            <div class="my-4">
                     <p class="f-icon-text"><span class="f-icon"><i class="fa-solid fa-money-bill-transfer fa-2x text-white" style="margin-bottom: 10px;"></i></span><br/> Safe & Reliable Payment </p>
                </div>            
            </div>
             <div class="col-lg-3 col-sm-6">
            <div class="my-4">
                    <p class="f-icon-text"><span class="f-icon"><i class="fa-solid fa-money-bill-trend-up fa-2x text-white" style="margin-bottom: 10px;"></i></span><br/> Money back Guarantee </p>
                </div>
            </div>
             <div class="col-lg-3 col-sm-6">
            <div class="my-4">
                    <p class="f-icon-text"><span class="f-icon"><i class="fa-solid fa-headset fa-2x text-white" style="margin-bottom: 10px;"></i></span><br/> 24/7 Customer Service </p>
                </div>
            </div>
         </div>
...
<section class="border-top mt-auto" style="background-color:#e2e2e2 !important;">
   ...
   <div class="col-lg-2 col-sm-6">
       <div class="my-4">
                 <h5 style="color:#000; font-size: 18px; font-weight: 500;" class="text-font">Sobkisu Bazar</h5>
                  <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/aboutus">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">About Us</h4>
                </a>
                    </li>
                 <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/resource">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">Resources</h4>
                </a>
                </li>
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/ourservices">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">Our Services</h4>
                </a>
                </li>
                  <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/buyerPartner">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">Buyer Partner</h4>
                </a>
                </li>
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/supplierPartner">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">Supplier Partner</h4>
                </a>
                </li>
                <li style="list-style:none;"><a class="text-reset d-block" href="#">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">Affiliate</h4>
                </a>
                </li>
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/sitemap">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">Sitemap</h4>
                </a>
                </li>
               
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/sobkisubazarBlog">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">Sobkisu Bazar Blog </h4>
                </a>
                </li>
                  <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/faq">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">FAQ</h4>
                </a>
                </li>
               </div>
    ...
    <div class="col-lg-3 col-sm-6">
       <div class="my-4">
                ...
                <li style="list-style:none;"><a class="text-reset d-block" href="https://sobkisubazar.com/terms">
                    <h4 class="h6 text-left text-dark text-font footer-text-hover" style="font-size:14px;">Terms & Condition</h4>
                </a>
                </li>
